...
const ClearanceByIdPage = () => {
  ...
  return (
    <div className="w-full h-full">
      ...
      {result && result.data && result.data.clearance ? (
        <div>
                    ...
                    <div className=" grid lg:grid-cols-3 md:grid-cols-2 grid-cols-2 overflow-hidden gap-4 p-4">
                      <div className="w-full">
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-sm capitalize">
                            MRCR/
                            {moment(
                              result.data.clearance.request.createdAt
                            ).format("YYYY")}
                      ...
                      <div className="w-full">
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-sm capitalize">
                            {snakeToSentence(
                              result.data.clearance.request.type
                            )}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="w-full">
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-sm capitalize">
                            {
                              result.data.clearance.request.activity?.project
                                ?.donor?.code
                            }
                          </p>
                        </div>
                      ...
                      <div className="w-full">
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-sm capitalize">
                            {result.data.clearance.request?.unit?.name || "N/A"}
                          </p>
                        </div>
                      </div>
                      <div className="w-full">
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-sm capitalize">
                            {result.data.clearance.request?.submittedBy?.name ||
                              "N/A"}
                          </p>
                        </div>
                      </div>
                      <div className="w-full">
                        <div className="flex flex-col gap-1">
                          ...
                          <p className="text-sm capitalize">
                            {result.data.clearance.request
                              ?.submittedDesignation || "N/A"}
                          </p>
                        </div>
                      </div>
                    </div>
                        ...
                        <div className="py-3 px-4 text-sm flex flex-col gap-1">
                          ...
                          <p>
                            {result.data && result.data.clearance.submittedAt
                              ? moment(
                                  result.data.clearance.submittedAt
                    ...
                    <div className="w-full">
                      <div>
                        ...
                        <div className="py-3 px-4 text-sm flex flex-col gap-1">
                          <p>
                            {result.data &&
                            result.data.clearance.budgetApprovedBy
                    ...
                    <div className="w-full">
                      <div>
                        ...
                        <div className="py-3 px-4 text-sm flex flex-col gap-1">
                          <p>
                            {result.data &&
                            result.data.clearance.financeApprovedBy
                        ...
                        <div className="py-3 px-4 text-sm flex flex-col gap-1">
                          ...
                          <p>
                            {result.data && result.data.clearance.completedAt
                              ? moment(
                                  result.data.clearance.completedAt
                                ).format("DD MMM YYYY HH:mm")
                              : ""}
                          </p>
